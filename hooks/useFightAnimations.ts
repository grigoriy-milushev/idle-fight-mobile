 ...
 */
export function useFightAnimations(
  userAttacked?: number,
  ...
  const showFloatingNumber = useCallback(
    (
      ...
      const setFloatingNumbers =
        target === "opponent" ? setMonsterNumbers : setUserNumbers;
  ...
  const removeFloatingNumber = useCallback(
  ...
  return {
    ...
    removeMonsterDamage: useCallback(
      (id: string) => removeFloatingNumber(id, "opponent"),
      [removeFloatingNumber]
    ),
    removeUserDamage: useCallback(
      (id: string) => removeFloatingNumber(id, "user"),
      [removeFloatingNumber]
    ),
