...
export function FloatingNumber({
  ...
  useEffect(() => {
    ...
    translateY.value = withTiming(FLOAT_DISTANCE, {duration: FLOAT_DURATION}, () => scheduleOnRN(onComplete))
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [])

  const animatedStyle = useAnimatedStyle(() => ({
    opacity: opacity.value,
    transform: [{translateX: horizontalOffset}, {translateY: translateY.value}]
  }))
